  ...
  if (msg.type === "user") {
    return (
      <div className="flex justify-end gap-3 group">
        <div className="max-w-[72%] rounded-2xl rounded-tr-sm bg-neutral-800 text-neutral-100 px-4 py-2.5 text-sm leading-relaxed whitespace-pre-wrap dark:bg-neutral-700">
          {msg.content}
